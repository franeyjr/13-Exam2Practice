...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        for k in range(number_of_characters_to_append,len(additional_contents)):
            remainder = remainder + additional_contents[k]
        return remainder
    ...
    def double(self):
        ...
        #######################################################################
        space = self.volume - len(self.contents)
        number_of_characters_to_append = space - len(self.contents)
        remainder = ''
        for k in range(number_of_characters_to_append):
            self.contents = self.contents + self.contents[k]
        for k in range(number_of_characters_to_append,len(self.contents)):
            remainder = remainder + self.contents[k]
        return remainder
