...
def run_test_practice_problem2a():
    ...
    print('Test 2')
    expected = [0, 6, -19, -24, 4]
    actual = practice_problem2a([4, 10, -15, -20, 8],-4)
    print('expected:',expected)
    print('actual:  ', actual)

    print('Test 3')
    expected = [18, 26, 21, -4, 24]
    actual = practice_problem2a([8, 16, 11, -14, 14],10)
    print('expected:',expected)
    print('actual:  ', actual)

    print('Test 4')
    expected = [16,17,18,19,20,21,22,23,24]
    actual = practice_problem2a([1,2,3,4,5,6,7,8,9],15)
    print('expected:',expected)
    print('actual:  ', actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        blah = sequence[k]
        if len(blah) > 0:
            first_letters = first_letters + blah[0]
